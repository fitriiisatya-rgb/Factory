...
echo "--- 8/9: starting php -S dev server on :$PHP_PORT (with the shared _ui_router.php, so /api/assets/*.css|png serve correctly) and running PhaseInvoiceUiTest.php (INV-UI01..14) ---"
