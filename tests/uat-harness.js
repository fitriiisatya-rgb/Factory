...
;(function(){
  window.__API__ = {
    ...
    fgMaterializeAll, fgStoreRows, fgGetPacked, fgTandaiSiap,
    ...
    kBuildGrid, kBaca, kHitung, kSimpan, kTarikDariFG, kProdukPesanan, kSudahKirim,
    kInvoiceBaca, kInvoiceSimpan, kInvoiceHitung, kBukaInvoice, fillInvoiceTokoSelect,
    invoiceNomor, doNomor, fgReadyList,
